...
export default function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900 z-0">
      ...
      <header className="fixed top-[65px] left-0 w-full z-30 md:hidden flex items-center justify-between p-4 bg-white dark:bg-gray-800 shadow-md">
        <button
      ...
      > */}
      <aside
          className={`fixed top-[65px] left-0 bottom-[40px] z-40 flex flex-col p-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 transition-all duration-300 ease-in-out shadow-lg
      ...
      {/* Main Content Area */}
      <main className="flex-1 p-4 pt-20 sm:pt-40 transition-all duration-300 ease-in-out md:ml-20 md:pt-4">
